...
class Figure3d(object):
    ...
    def __init__(self,
        ...
        settings.abs_z_restr = abs_z_restr
        ...
        self.fig_global_phase_difference_of_times_analysis = fig_global_phase_difference_of_times_analysis(ax_13, settings)
        self.fig_number_imbalance_of_times_analysis = fig_number_imbalance_of_times_analysis(ax_23, settings)
        # =========================================================================================
