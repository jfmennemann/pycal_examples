...
class fig_density_y_eff(object):
    ...
    def __init__(self, ax, settings):
        ...
        self.line_density_y_eff, = ax.plot(settings.y, zeros_like(settings.y), linewidth=1, linestyle='-', color=colors.wet_asphalt)
        ...
        ax.set_ylim(settings.density_y_effective_min, settings.density_y_effective_max)
